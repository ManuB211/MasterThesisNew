...
public class Bpmn2PrivateModelTest {
	...
	public void test() throws Exception {
		...
		IOUtils.toFile(example.privateModel.getName()+"Bpmn2PrivateModelTest.dot", example.privateModel.getdigraph().toDOT());
		...
		Iterator<IRPSTNode<Edge<IPrivateNode>, IPrivateNode>> I = ((PrivateModel) example2.privateModel).Loops.iterator();
