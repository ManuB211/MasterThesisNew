...
public class PrivateModel2Bpmn {
    ...
    private final Collection<Edge<IPrivateNode>> edges;
    private final String modelName;
    private final Set<IPrivateNode> nodes = new HashSet<IPrivateNode>();
    private final Set<Role> roles = new HashSet<Role>();
    private Role processOwner = null;

    private final List<Element> flowNodeRefs = new ArrayList<Element>();
    private final List<Element> seqFlows = new ArrayList<Element>();
    private final List<Element> processNodes = new ArrayList<Element>();
