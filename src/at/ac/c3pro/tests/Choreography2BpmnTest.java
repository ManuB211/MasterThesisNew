...
public class Choreography2BpmnTest {
	...
	BookTripChoreoModel = new Bpmn2ChoreographyModel("target/Book_Trip_OperationExtended.xml", "BookTripOperationExtended");
	...
	public void test() throws Exception {
		...
		MultiDirectedGraph<Edge<IChoreographyNode>,IChoreographyNode> digraph = (MultiDirectedGraph<Edge<IChoreographyNode>, IChoreographyNode>) BookTripChoreoModel.choreoModel.getdigraph();
		ChoreographyModel choreoModel = new ChoreographyModel(digraph);
		ChoreographyModel2Bpmn choreo2bpmnIO = new ChoreographyModel2Bpmn(choreoModel, "BookTripOperationExtended_Reversed", "target/");
		...
		MultiDirectedGraph<Edge<IChoreographyNode>,IChoreographyNode> genGraph = (MultiDirectedGraph<Edge<IChoreographyNode>, IChoreographyNode>) genModel.choreoModel.getdigraph();
