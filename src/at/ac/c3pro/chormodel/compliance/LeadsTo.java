...
public class LeadsTo extends OrderPattern {
    ...
    /*
     * possible p assignments: - every interaction, except the last one possible q
     * assignments: - every interaction on path after p (not within XOR)
     */
    @Override
    ...
    private ArrayList<Interaction> getPossibleQs(IChoreographyNode node, Branch currentBranch,
                                                 ArrayList<Interaction> possibleQs) {
        if (node != null)
    ...
    private ArrayList<Interaction> getPossibleQsInnerBranch(IChoreographyNode node, Branch currentBranch,
                                                            ArrayList<Interaction> possibleQs) {
    ...
    private ArrayList<Interaction> getPossibleQsOuterBranch(IChoreographyNode node, Branch currentBranch,
                                                            ArrayList<Interaction> possibleQs) {
