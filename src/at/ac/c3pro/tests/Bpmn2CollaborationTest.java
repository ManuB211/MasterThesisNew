...
public class Bpmn2CollaborationTest {
    ...
    public void test() throws Exception { // CollaborationBookTripV3
        ...
        /*
         * Bpmn2PrivateModel example2 = new
         * Bpmn2PrivateModel("target/AcquirerPrivateProcess.xml","PrivateAcquirerModel")
         * ; IOUtils.toFile(example2.privateModel.getName()+"Bpmn2PrivateModelTest.dot",
         * example2.privateModel.getdigraph().toDOT()); Bpmn2ChoreographyModel example3
         * = new Bpmn2ChoreographyModel("target/BookTripOperation.xml",
         * "BookTripOperation"); IOUtils.toFile("BookTripBpmn2chorTest.dot",
         * example3.choreoModel.getdigraph().toDOT());
         */
