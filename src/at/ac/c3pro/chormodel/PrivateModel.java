...
import at.ac.c3pro.node.PublicNode;
...
public class PrivateModel extends RpstModel<Edge<IPrivateNode>, IPrivateNode> implements IPrivateModel{
	...
	/**
	 * @return  this function returns the behavioral Interface of a given PrivateModel
	 * Still to be done: graph reduction
	 */
	...
	/**
	 * @return  this function returns the list of next nodes of type gateway, InteractionActivity or Event of a given node
	 */
