...
import at.ac.c3pro.io.Bpmn2ChoreographyModel.Triple;
...
protected void initGraph() {
	...
	Set<IPrivateNode> privateNodes = new HashSet<IPrivateNode>(); //contains all created nodes of all public models: needed for building the map pu2puNode
	...
	if (digraph != null){
		privateModel = new PrivateModel(digraph, processName);
		 if (logger.isInfoEnabled()) logger.info("public model added: "+privateModel.getName());				
	}
	}
