...
public class Insert<E extends Edge<N>, N extends INode> extends ChangeOperation implements IChangeOperation {
    ...
    public Insert(RpstModel<E, N> f, RpstModel<E, N> model, N in, N out, Choreography c, Role currentRole) {
        super();
        this.f = f;
        this.model = model;
        this.in = in;
    ...
    public Insert(IRpstModel<E, N> f, IRpstModel<E, N> model, Set<N> in, Set<N> out, Choreography c, Role currentRole) {
        super();
