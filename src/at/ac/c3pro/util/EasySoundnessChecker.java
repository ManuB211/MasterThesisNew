...
public class EasySoundnessChecker {
    ...
    /**
     * Computes the topological ordering from our complete graph using Khans algorithm
    ...
    private List<IPublicNode> computeTopologicalOrder(MultiDirectedGraph<Edge<IPublicNode>, IPublicNode> graph, IPublicNode startGlobal) {
        ...
        //Set of Connections that were removed for Khans algorithm to work but need to be added again afterwards
    ...
    private MultiDirectedGraph<Edge<IPublicNode>, IPublicNode> buildCombinedPublicModel() {
        ...
        if (!puMs.isEmpty()) {
            ...
            if (visualize) {
                IOUtils.toFile(
                        GlobalTimestamp.timestamp + "/EasySoundness/CombinedPublicModel.dot",
                        rst != null ? rst.toDOT() : "");
            }
