...
public class PrivateModel2BpmnTest {
	...
	public void test() throws Exception {
		...
		MultiDirectedGraph<Edge<IPrivateNode>,IPrivateNode> digraph =  (MultiDirectedGraph<Edge<IPrivateNode>, IPrivateNode>) privateModelIO.privateModel.getdigraph();
		...
		MultiDirectedGraph<Edge<IPrivateNode>,IPrivateNode> genGraph =  (MultiDirectedGraph<Edge<IPrivateNode>, IPrivateNode>) genModel.privateModel.getdigraph();
